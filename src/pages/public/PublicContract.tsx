            ...
            >
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    <p style={{ fontSize: 13, fontWeight: 800, color: "#fff", margin: 0, letterSpacing: "-0.02em" }}>
                      Visualizar Contrato
                    </p>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{
                    ...
                    <span style={{ fontSize: 9, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.2em", color: "rgba(255,255,255,0.3)" }}>
                      Somente leitura
                    </span>
                  </div>
                  <button
              ...
              {/* Barra colorida */}
              <div style={{ height: 2, background: `linear-gradient(to right, ${ORANGE}80, transparent)`, flexShrink: 0 }} />
                  ...
                  <div style={{
                    ...
                    <iframe
                      ...
                      style={{
                        ...
                        display: "block", minHeight: 900,
                        pointerEvents: "none",
                      }}
                    />
                    {/* overlay que bloqueia cliques no iframe */}
...
export default function PublicContract() {
  ...
  const signMutation = useMutation({
    ...
    onError: (err: Error) => { toast.error(err.message || "Erro ao assinar contrato."); },
  });
  ...
  // Mapeia os dados do proposal para o formato ReviewData usado pelo builder
  ...
  const previewHtml = buildContractHtml(previewData);
    ...
    <div style={{ minHeight: "100vh", background: "#080808", color: "#fff", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main style={{ padding: "clamp(24px,5vw,48px) 24px 80px", position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 700, margin: "0 auto", display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          {/* ── Card de detalhes + botão Ver Contrato ── */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease: [0.16,1,0.3,1] }}>
            <div style={card}>
              ...
              <div style={{ padding: "24px 28px" }}>
                ...
                <div style={{ paddingTop: 20, borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
                  <div>
              ...
              <motion.div key="sign"
                ...
                <div style={card}>
                  ...
                  <div style={{ padding: "24px 28px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 14px", borderRadius: 9, background: `${ORANGE}0A`, border: `1px solid ${ORANGE}25`, marginBottom: 18 }}>
                      <Eye size={12} color={ORANGE} style={{ flexShrink: 0 }} />
                      <p style={{ fontSize: 11, color: "rgba(255,255,255,0.45)", margin: 0 }}>
                        Recomendamos{" "}
                        <button
                          onClick={() => setShowPreview(true)}
                          style={{ background: "none", border: "none", color: ORANGE, fontSize: 11, fontWeight: 700, cursor: "pointer", padding: 0, fontFamily: "inherit" }}
                        >
                    ...
                    <form onSubmit={handleSubmit(data => signMutation.mutate(data))}
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }} className="sign-grid">
                        <div>
                          ...
                          <input {...register("signerName")} placeholder="Seu nome completo"
                        ...
                        <div>
                          ...
                          <input {...register("signerDocument")} placeholder="000.000.000-00"
                            style={{ width: "100%", boxSizing: "border-box", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 9, padding: "10px 13px", color: "#fff", fontSize: 13, fontFamily: "inherit", outline: "none" }} />
